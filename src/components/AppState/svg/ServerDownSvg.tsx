...
export const ServerDownSvg = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path fill="#637eff" opacity={0.4} d="M271.609 150h16v16h-16z" />
    <path fill="#637eff" opacity={0.8} d="M294.609 150h16v16h-16z" />
    <path fill="#637eff" d="M317.609 150h16v16h-16z" />
    <path fill="#637eff" opacity={0.4} d="M271.609 251h16v16h-16z" />
    <path fill="#637eff" opacity={0.8} d="M294.609 251h16v16h-16z" />
    <path fill="#637eff" d="M317.609 251h16v16h-16z" />
    <path fill="#637eff" opacity={0.4} d="M271.609 352h16v16h-16z" />
    <path fill="#637eff" opacity={0.8} d="M294.609 352h16v16h-16z" />
    <path fill="#637eff" d="M317.609 352h16v16h-16z" />
