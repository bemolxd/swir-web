...
export const add =
  <Value extends SimpleType>(path: string, value: Value) =>
...
export const remove =
  ...
  <Object = object>(object: Object): Object => {
    ...
    return omit(object as unknown as {}, path) as unknown as Object;
  };

export const has =
  <Object = object>(object: Object) =>
  <Value extends SimpleType>(path: string, value?: Value): boolean => {
    const result = lodashGet(object, path);
...
export const without =
  (paths: string | string[]) =>
  <Object = object>(object: Object): Partial<Object> =>
    omit(object as unknown as {}, paths);
...
export const pick =
  ...
  <Object = object>(object: Object): Partial<Object> => {
    ...
    if (Object.keys(result).length === 0) return object;
...
export const get =
  <Object = object>(object: Object) =>
  <DefaultVal extends Value>(path: string, defaultValue?: DefaultVal): Value =>
